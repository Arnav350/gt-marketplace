...
In toDoAPI/todo/views.py I created two classes that handle CRUD operations.   
  The TodoListCreate class handles POST and GET (All) operations. https:..../todos/
  The TodoDetail class handles PATCH, DELETE, and GET (<ID>) operations https:..../todos/<pk:id>/
