...
type SearchItemsScreenNavigationProp = StackNavigationProp<
  MarketplaceStackParamList,
  'SearchItems'
>;

type SearchItemsScreenRouteProp = RouteProp<
  MarketplaceStackParamList,
  'SearchItems'
>;

const SearchItemsScreen: React.FC = () => {
  ...
  const handleSearch = (text: string) => {
    ...
    setFilteredItems(
      items.filter((item) => item.name.toLowerCase().includes(text.toLowerCase()))
    );
  };
